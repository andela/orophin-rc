...
Logs.attachSchema(Schemas.Wallets);

/*
 * ProductsReviews Collection
 * @ignore
 */
export const ProductReviews = new Mongo.Collection("ProductReviews");
ProductReviews.attachSchema(Schemas.Reviews);

/**
 * ProductsRatings Collection
 * @ignore
 */
export const ProductRatings = new Mongo.Collection("ProductRatings");
ProductRatings.attachSchema(Schemas.Ratings);

/**
 * ShopReviews Collection
 * @ignore
 */
export const ShopReviews = new Mongo.Collection("ShopReviews");
ShopReviews.attachSchema(Schemas.Reviews);

/**
 * ShopRatings Collection
 * @ignore
 */
export const ShopRatings = new Mongo.Collection("ShopRatings");
ShopRatings.attachSchema(Schemas.Ratings);
