...
export default {
  ...
  defaultCustomerRoles: ["guest", "account/profile", "product", "tag", "index", "cart/checkout", "cart/completed", "pages", "categories"],
  defaultVisitorRoles: ["anonymous", "guest", "product", "tag", "index", "cart/checkout", "cart/completed", "pages", "categories"],
  createGroups,
  /**
   * canInviteToGroup
